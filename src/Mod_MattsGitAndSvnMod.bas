...
Private Sub Commit2Subversion(fileOrFolder As String)
...
Private Sub UpdateFromSubversion(fileOrFolder As String)
...
Private Sub Commit2Git(fileOrFolder As String)
...
Private Sub FetchFromGit(fileOrFolder As String)
